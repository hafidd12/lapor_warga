  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppTheme.outlineVariantColor.withOpacity(0.7),
        ),
        boxShadow: [
          BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppTheme.outlineVariantColor.withOpacity(0.65),
        ),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.035),
                  ...
                  Expanded(
                    child: OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: BorderSide(
                          color: AppTheme.outlineVariantColor.withOpacity(0.9),
                        ),
